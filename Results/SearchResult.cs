...
namespace Movies.Results
{
    public class SearchResult
    {
        ...
        public SearchResult(IConfiguration configuration)
        {
        ...
        public MovieModel Result(HttpResponseMessage result)
        {
            ...
            try
            {
                ...
                SimilarMoviesService similarMovieService = new SimilarMoviesService(_configuration);

                string resultSimilarMovies = similarMovieService.GetSimilarMovies(movies.results[0].id);
